...
export default async function EquipePage() {
  ...
  return (
    <AdminShell
      acesso={acesso}
      active="/painel/gestao/equipe"
      title="Equipe"
      subtitle="Profissionais, unidades onde atendem e escala semanal."
      actions={
        <Link href="/painel/gestao/equipe/novo">
        ...
        <table className="w-full text-[0.9375rem]">
          ...
          <tbody>
            {staff.map((s) => (
              ...
              >
                <td className="p-3.5">
                  <Link href={href(`/painel/gestao/equipe/${s.id}`)} className="flex items-center gap-2 font-medium hover:underline">
                    <span
