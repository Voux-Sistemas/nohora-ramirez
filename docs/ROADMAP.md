...
**A área da dona.** `/admin` com painel de faturação e marcações por loja, comparativo de mês e
apuramento de comissão por profissional; e registo de unidades,
serviços, equipa e recursos — incluindo horário de funcionamento, feriados, escalas, matriz de
